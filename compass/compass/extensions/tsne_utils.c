...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/data/yosef/users/schel337/lib/numpy/core/include/numpy/arrayobject.h", 
            "/data/yosef/users/schel337/lib/numpy/core/include/numpy/npy_math.h", 
            "/data/yosef/users/schel337/lib/numpy/core/include/numpy/ufuncobject.h"
        ], 
        "include_dirs": [
            "/data/yosef/users/schel337/lib/numpy/core/include"
        ], 
...
static int __pyx_pymod_exec_tsne_utils(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init compass.compass.extensions.tsne_utils", 0, __pyx_lineno, __pyx_filename);
    }

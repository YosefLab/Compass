...
.. note::
   We are deprecating the compassR code as it does not follow the manuscript as closely as we'd like. There is now a python version `here <https://github.com/YosefLab/Compass/blob/analysis/analysis/Demo.ipynb>`__, though it may undergo some revisions.
